...
namespace UrlImageViewHelper
{
	public static class ExtensionMethods
	{
        ...
        public static void SetUrlDrawable(this ImageView imageView, string url, Drawable defaultDrawable, IUrlImageViewCallback callback, UrlImageViewHelper.ProcessImageDelegate processImage) 
		{
            UrlImageViewHelper.SetUrlDrawable(imageView, url, defaultDrawable, callback, processImage);
	    }
