...
namespace UrlImageViewHelper
{
	...
	{
        public delegate byte[] ProcessImageDelegate(byte[] imageData);
		...
		{
			SetUrlDrawable(imageView.Context, imageView, url, null, CACHE_DURATION_THREE_DAYS, null, null);
		}

		public static void LoadDrawable(Context context, string url)
		{
			 SetUrlDrawable(context, null, url, null, CACHE_DURATION_THREE_DAYS, null, null);
		}

		public static void SetUrlDrawable(ImageView imageView, string url, Drawable defaultDrawable)
		{
			SetUrlDrawable(imageView.Context, imageView, url, defaultDrawable, CACHE_DURATION_THREE_DAYS, null, null);
		}
		...
		{
			SetUrlDrawable(context, null, url, null, cacheDurationMs, null, null);
		}

		public static void SetUrlDrawable(ImageView imageView, string url, Drawable defaultDrawable, long cacheDurationMs)
		{
			SetUrlDrawable(imageView.Context, imageView, url, defaultDrawable, cacheDurationMs, null, null);
		}
		...
		private static void SetUrlDrawable(Context context, ImageView imageView, string url, int defaultResource, long cacheDurationMs)
		{
			...
			SetUrlDrawable(context, imageView, url, d, cacheDurationMs, null, null);
		}

		public static void SetUrlDrawable(ImageView imageView, string url, IUrlImageViewCallback callback) 
		{
        	SetUrlDrawable(imageView.Context, imageView, url, null, CACHE_DURATION_THREE_DAYS, callback, null);
	    }

	    public static void LoadUrlDrawable(Context context, string url, IUrlImageViewCallback callback) 
		{
	        SetUrlDrawable(context, null, url, null, CACHE_DURATION_THREE_DAYS, callback, null);
	    }

        public static void SetUrlDrawable(ImageView imageView, string url, Drawable defaultDrawable, IUrlImageViewCallback callback, ProcessImageDelegate processImage) 
		{
            SetUrlDrawable(imageView.Context, imageView, url, defaultDrawable, CACHE_DURATION_THREE_DAYS, callback, processImage);
	    }
		...
		{
	        SetUrlDrawable(context, null, url, null, cacheDurationMs, callback,null);
	    }
		...
		{
	        SetUrlDrawable(imageView.Context, imageView, url, defaultDrawable, cacheDurationMs, callback,null);
	    }
	    ...
	    private static void SetUrlDrawable(Context context, ImageView imageView, string url, int defaultResource, long cacheDurationMs, IUrlImageViewCallback callback) 
		{
	        ...
	        if (defaultResource != 0)
				d = imageView.Resources.GetDrawable(defaultResource);
	        SetUrlDrawable(context, imageView, url, d, cacheDurationMs, callback, null);
	    }
        ...
        public static BitmapDrawable LoadDrawableFromFile(Context context, string filename, ImageView imageView) 
        {
        ...
        //    //using (var bitmap = Android.Graphics.BitmapFactory.DecodeFile(filename, options))
        //    //{
        //    //    return new BitmapDrawable(mResources, bitmap);
        //    //}
        ...
        //    int requiredWidth = imageView.MeasuredWidth;
        //    int requiredHight = imageView.MeasuredHeight;
        //    int scale = 1;
        //    while (o.OutWidth / scale / 2 >= requiredWidth
        //            && o.OutHeight / scale / 2 >= requiredHight)
        //        scale *= 2;

        //    BitmapFactory.Options o2 = new BitmapFactory.Options();
        //    o2.InSampleSize = scale;
        //    //return BitmapFactory.DecodeFile(filePath, o2);
        //    using (var bitmap = Android.Graphics.BitmapFactory.DecodeFile(filename, o2))
        //    {
        //        return new BitmapDrawable(mResources, bitmap);
        //    }
        ...
        private static void SetUrlDrawable(Context context, ImageView imageView, string url, Drawable defaultDrawable, long cacheDurationMs, IUrlImageViewCallback callback, ProcessImageDelegate processImage)
		{
			Cleanup(context);
			...
			if (file.Exists)
			{
				try
				{
					...
					{
                        drawable = LoadDrawableFromFile(context, filename, imageView);
			...
			var downloaderTask = new AnonymousAsyncTask<string, string, BitmapDrawable>((p) => 
			{
				try
				{
                    ...
                    return LoadDrawableFromFile(context, filename, imageView);
				}
				catch (Exception ex) 
				{
