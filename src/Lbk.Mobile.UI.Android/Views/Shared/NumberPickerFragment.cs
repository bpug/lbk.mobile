...
namespace Lbk.Mobile.UI.Droid.Views.Shared
{
    ...
    public class NumberPickerFragment : MvxDialogFragment
    {
        ...
        public NumberPickerFragment(Context context)
        {
        ...
        public override Dialog OnCreateDialog(Bundle savedInstanceState)
        {
            ...
            var view = this.BindingInflate(Resource.Layout.Dialog_NumberPicker, null);
            //var np = view.FindViewById<NumberPicker>(Resource.Id.mvxdate_picker);

            var builder = new AlertDialog.Builder(this.context);
            builder.SetIconAttribute(Android.Resource.Attribute.CalendarViewShown);
            builder.SetTitle("Plätze");
